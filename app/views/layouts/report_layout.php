		...
		<table class="table table-sm">
			<tr>
				...
				<th align="left" valign="middle">
					...
					<small class="sub-title">Aplikasi Pencatatan SEP</small>
				</th>
				<th align="right" valign="middle">
					<div class="company-info">
						<div>Phone: <span class="sub-title">(0295) 4150645</span></div>
						<div>Email: <span class="sub-title">sebeningkasih@yahoo.co.id<?php echo SITE_NAME ?></span></div>
