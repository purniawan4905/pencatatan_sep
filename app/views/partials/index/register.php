                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input id="ctrl-username"  value="<?php  echo $this->set_field_value('username',""); ?>" type="password" placeholder="Enter Username"  required="" name="username"  data-url="api/json/pengguna_username_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available" class="form-control  password password-strength ctrl-check-duplicate" />
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <input id="ctrl-username-confirm" data-match="#ctrl-username"  class="form-control password-confirm " type="password" name="confirm_password" required placeholder="Confirm Password" />
                                                    <div class="input-group-append cursor-pointer btn-toggle-password">
                                                        <span class="input-group-text"><i class="fa fa-eye"></i></span>
                                                    </div>
