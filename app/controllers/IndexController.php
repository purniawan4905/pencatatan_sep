...
class IndexController extends BaseController{
	...
	function register($formdata = null){
		if($formdata){
			...
			$db = $this->GetModel();
			$tablename = $this->tablename;
			$fields = $this->fields = array("username","password","email","photo"); //registration fields
			...
			$password_text = $modeldata['username'];
			//update modeldata with the password hash
			$modeldata['username'] = $this->modeldata['username'] = password_hash($password_text , PASSWORD_DEFAULT);
